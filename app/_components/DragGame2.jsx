...
const items = [
    { id: 1, text: "Stops known threats quickly", type: "file" },
    { id: 2, text: "Can’t detect zero-day malware", type: "file" },
    { id: 3, text: "Needs daily updates to stay effective", type: "file" },
    { id: 4, text: "Detects suspicious behavior", type: "os" },
    { id: 5, text: "May flag legitimate software", type: "os" },
    { id: 6, text: "Does not rely on known signatures", type: "os" },
];
    ...
    return (
        <div className="mx-auto max-w-4xl p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                {renderZone("Definitions", "file", fileZone, setFileZone)}
                {renderZone("Heuristic", "os", osZone, setOsZone)}
            </div>
        </div>
    )
}

export default DragGame2